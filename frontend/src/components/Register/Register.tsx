...
export const RegistrationForm = () => {
  ...
  return (
    <div className="bg-secondary relative w-full max-w-xl rounded-[2.5rem] p-10 shadow-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <button
          type="submit"
          className={`col-span-2 mx-auto mt-4 h-12 w-64 rounded-2xl border-0 bg-purple-600 text-lg font-bold text-white shadow-lg transition-all hover:opacity-90`}>
          REGISTRAR
        </button>
      </form>
    </div>

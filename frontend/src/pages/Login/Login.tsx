...
export const Login: React.FC = () => {
  ...
  const mainBgClass = "bg-[#fcf8fc]";
  const formBgClass = "bg-[#f5eaf7]";
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center ${mainBgClass}`}>
      <Toast ref={toast} />
      <div className={`${formBgClass} rounded-[2.5rem] p-10 shadow-xl w-[420px] flex flex-col items-center`}>
        ...
        >
          ...
          <Button
            ...
            type="submit"
            loading={loading}
            className="w-full h-12 rounded-2xl text-white font-bold shadow-lg bg-[#eabaff] border-0 hover:opacity-90 transition-all text-lg mt-1"
          />

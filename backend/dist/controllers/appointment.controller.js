...
class AppointmentController {
    constructor() {
        ...
        this.createAppointmentAsMedic = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (request.user && request.user.role === "patient") {
                    body.patient_id = request.user.id;
                }
                const appointment = yield this.appointmentService.createAppointment(body);
        ...
        this.createAppointmentAsPatient = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (request.user && request.user.role === "medic") {
                    body.medic_id = request.user.id;
                }
                const appointment = yield this.appointmentService.createAppointment(body);
                return response.status(201).json({
                    success: true,
        ...
        this.getMedicAppointments = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { start_date, end_date } = request.query;
                const medicId = request.user.id;
                const appointments = yield this.appointmentService.getAppointmentsByMedic(medicId, start_date, end_date);
        ...
        this.getPatientAppointments = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { start_date, end_date } = request.query;
                const patientId = request.user.id;
                const appointments = yield this.appointmentService.getAppointmentsByPatient(patientId, start_date, end_date);
                return response.status(200).json({
                    success: true,
        ...
        this.getMedicAppointmentById = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.getPatientAppointmentById = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = request.params;
                const appointment = yield this.appointmentService.getAppointmentById(parseInt(id));
                if (!appointment) {
        ...
        this.updateMedicAppointment = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_cita } = request.params;
                const body = request.body;
                const appointment = yield this.appointmentService.updateAppointment(parseInt(id_cita), body, "medic");
                return response.status(200).json({
                    success: true,
        ...
        /**
         * @swagger
         * /api/paciente/appointments/{medic_id}/{id_cita}:
         *   put:
        ...
        this.updatePatientAppointment = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_cita } = request.params;
                const body = request.body;
                const appointment = yield this.appointmentService.updateAppointment(parseInt(id_cita), body, "patient");
                return response.status(200).json({
                    success: true,
                    message: "Cita actualizada exitosamente",
                    data: appointment,
        ...
        this.deleteMedicAppointment = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_cita } = request.params;
                yield this.appointmentService.deleteAppointment(parseInt(id_cita));
        ...
        this.deletePatientAppointment = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_cita } = request.params;
                yield this.appointmentService.deleteAppointment(parseInt(id_cita));
                return response.status(204).json({
